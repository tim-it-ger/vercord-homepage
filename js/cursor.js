...
const hamBtn = document.querySelector(".okiguessvaticiscool-button");
const hamWrap = document.querySelector(".okiguessvaticiscool-wrapper");
...
hamBtn.addEventListener("mousemove", function () {
  if (document.querySelector(".okiguessvaticiscool-button-active")) {
...
hamBtn.addEventListener("mouseleave", function () {
  root.style.setProperty("--cursor-color-one", "#468bfad0");
  root.style.setProperty("--cursor-color-two", "transparent");
  root.style.setProperty("--cursor-color-three", "#468bfad0");
});
